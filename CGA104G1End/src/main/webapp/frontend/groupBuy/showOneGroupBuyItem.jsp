			...
			<div class="container-fluid">
				...
				<div>
					<a href="cart.html" style="text-decoration: none; margin-left: 10px; color: #484747">
						<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16" style="margin-bottom: 10px">
					...
					<div class="col-sm-6">
						...
						<form class="cart">
							...
							<a href="#" class="btn btn-rounded btn-dark" id="addToCart"
								...
								class="btn btn-rounded btn-dark" onclick="addToTrace()" id="Trace"><span>trace</span></a>
...
function showgroupbuypicture(e) {
    //取出圖片
    $.ajax({
    ...
    function showAllPic(data) {
        ...
        console.log(pics);
        let div = document.querySelector(".itemdetail");
        let groupBuyItemPictureHTML = "";
        ...
        `;
        console.log("我是pics[i]");
        console.log(pics[i]);
        }
        div.innerHTML = groupBuyItemPictureHTML;
    }
}
