...
@WebServlet("/groupBuyItemPictureGetSecond")
public class groupBuyItemPictureGetSecond extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public groupBuyItemPictureGetSecond() {
    }
...
//		groupBuyItemPictureVO gbipVO = gbipSvc.getOneGroupBuyItemPicture(gbitem_id);
		groupBuyItemPictureVO gbipVO = gbipSvc.getSecondGroupBuyItemPictureByGbitemID(gbitem_id);
